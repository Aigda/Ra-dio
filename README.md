...
WiFi Direct Transceiver

PTT (Push-to-Talk)

Регистрация DNS-SD сервиса

Голосовое сообщение

TXT-запись с текстом

Частота/канал

Имя сервиса (WFD\_Main, WFD\_Msg)

Позывной

Device ID (8 символов)
...
Heartbeat, статус, позывной

Постоянно (обновление 5 сек)
...
_73 — радиолюбительский код «Наилучшие пожелания»_